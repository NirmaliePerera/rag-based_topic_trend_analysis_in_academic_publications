...
# After author extraction enhancement
PRED_DIR = os.path.join(PROJECT_ROOT, "output_data", "grobid_author_enhancement")
...
OUT_DIR = os.path.join(PROJECT_ROOT, "output_data", "Evaluation_Output", "evaluations", "grobid_author_enhancement")
